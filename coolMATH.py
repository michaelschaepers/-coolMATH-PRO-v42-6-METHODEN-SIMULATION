...
def check_login():
    ...
    with col_m:
        ...
        if st.button("Einloggen", width="stretch", type="primary"):
...
def main():
    ...
    with wrd2:
        ...
        if st.button("💾 PROJEKT SPEICHERN", width="stretch"):
    ...
    with wrd3:
        ...
        if st.button("📤 MONDAY UPLOAD", width="stretch"):
